...
等待完成!!内核修改需要时间非常多!
重启
GRUB引导菜单 方向键下  *Advanced回车  选择Linux 6.12.??无+deb13-amd64后缀
```
...
- /补丁
  ...
  > 复制qemu-10.2.2.tar.xz源码压缩包	//	[qemu源码](https://www.qemu.org/)   
  > 到 /home/你的用户名/  
...
显卡功能[通常是HDMI音频]如01:00:1, 03:00:1  后缀:1 不要添加
...
![这是图片](补丁/截图/unknown_2026.05.22-15.14_1.png "win10 VM")
